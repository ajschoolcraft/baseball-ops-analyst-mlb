...
# [What is WAR?](https://library.fangraphs.com/misc/war/ "Permanent link to What is WAR?")
...
**●**[For Position Players](http://www.fangraphs.com/library/war/war-position-players/)

**●**[For Pitchers](http://www.fangraphs.com/library/war/calculating-war-pitchers/)

**Calculation:**

Calculating WAR, especially for position players, is simpler than you’d think. If you want the detailed version with the precise steps and formulas, head to our page on [Position Player WAR](http://www.fangraphs.com/library/war/war-position-players/) or [Pitcher WAR](http://www.fangraphs.com/library/war/calculating-war-pitchers/). The short answer, though, is as follows:
...
Using WAR properly is difficult because it requires you to think more abstractly than some other aspects of life. The exact number is not as important as the basic range, but this isn’t just true of WAR. [This is the case with all statistics in all parts of the game](http://www.fangraphs.com/library/the-beginners-guide-to-using-statistics-properly/).
...
Also, here’s a fun breakdown of all the players in baseball in 2010, courtesy of [Justin Bopp from Beyond the Boxscore](http://www.beyondtheboxscore.com/2010/11/16/1813082/how-common-is-a-one-win-above-replacement-player).

**Things to Remember:**

● Because there is no UZR data for catchers, the [fielding component](http://www.fangraphs.com/blogs/catcher-defense-in-war/) for catcher fWAR is calculated using two parts: the [Stolen Base Runs Saved (rSB)](http://www.fangraphs.com/library/defense/drs/) metric from the Fielding Bible, and [Runs saved from Passed Pitches (RPP)](http://www.fangraphs.com/blogs/catcher-pitch-blocking-war-update/). This accounts for a large portion of a catcher’s value, although pitch framing is not yet included in WAR. For this reason, catcher WAR is probably the least precise of all of the positions.
...
● There are currently 1,000 WAR per season based on a replacement level of a [.294 winning percentage](http://www.fangraphs.com/blogs/unifying-replacement-level/). Of those 1,000, 570 WAR are allocated to position players and 430 WAR are allocated to pitchers. You can learn more about the split [here](http://www.fangraphs.com/blogs/a-discussion-about-improving-war/).

**Links for Further Reading:**

[WAR for Position Players – FanGraphs](http://www.fangraphs.com/library/war/war-position-players/)

[WAR for Pitchers – FanGraphs](http://www.fangraphs.com/library/war/calculating-war-pitchers/)

[Intro to WAR – Big League Stew](http://sports.yahoo.com/mlb/blog/big_league_stew/post/Everything-you-always-wanted-to-know-about-WAR?urn=mlb,211211)

Background on WAR – Offense (Note that these are slightly outdated. They have great info, but some calculations have changed.)

* [Part 1](http://www.fangraphs.com/blogs/win-values-explained-part-one) – Batting
* [Part 2](http://www.fangraphs.com/blogs/win-values-explained-part-two) – Fielding
* [Part 3](http://www.fangraphs.com/blogs/explaining-win-values-part-three) – Positional
* [Part 4](http://www.fangraphs.com/blogs/win-values-explained-part-four) – Replacement
* [Part 5](http://www.fangraphs.com/blogs/win-values-explained-part-five) – Converting Runs to Wins
* [Part 6](http://www.fangraphs.com/blogs/win-values-explained-part-six) – Dollars
* [Part 7](http://www.fangraphs.com/blogs/win-values-explained-part-seven) – Additional Info.
* [Part 8](http://www.fangraphs.com/blogs/win-values-explained-part-eight/) – Team Context
...
* [Part 3](http://www.fangraphs.com/blogs/pitcher-win-values-explained-part-three) – Replacement
* [Part 4](http://www.fangraphs.com/blogs/pitcher-win-values-explained-part-four) – Run Environments
* [Part 5](http://www.fangraphs.com/blogs/pitcher-win-values-explained-part-five) – Converting Runs to Wins
...
[Common Misconceptions – The Book Blog](http://www.insidethebook.com/ee/index.php/site/comments/misconceptions_of_war/)

[Simple WAR Calculator – Wahoo’s On First](http://wahoosonfirst.com/war-calculator/)

[wOBA to WAR Conversion – Beyond the Boxscore](http://www.beyondtheboxscore.com/2009/11/10/1123343/woba-to-war-conversion-spreadsheet)
