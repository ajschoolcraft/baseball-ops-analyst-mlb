...
You can find OPS+ on Baseball-Reference. If you’re feeling ambition, we recommend replacing OPS with [wOBA](http://www.fangraphs.com/library/offense/woba/) and OPS+ with [wRC+](http://www.fangraphs.com/library/offense/wrc/).
...
We don’t house OPS+ on the site, but the [calculation can be found at Baseball-Reference.](http://www.baseball-reference.com/about/bat_glossary.shtml)
...
Please note that the following chart is meant as an estimate, and that league-average OPS varies on a year-by-year basis. To see the league-average OPS for every year from 1901 to the present, [check the FanGraphs leaderboards](http://www.fangraphs.com/leaders.aspx?pos=all&stats=bat&lg=all&qual=0&type=1&season=2015&month=0&season1=1901&ind=0&team=0,ss&rost=0&players=0&sort=0,d).
...
● If you have the choice, use [Weighted On-Base Average (wOBA)](http://www.fangraphs.com/library/offense/woba/) instead of OPS. OPS weighs both OBP and SLG the same, while wOBA accounts for the fact that OBP is actually more valuable.
...
[Visually Comparing OPS and wOBA – FanGraphs](http://www.fangraphs.com/blogs/a-visual-look-at-woba/)

[Intro to OPS+ – Big League Stew](http://sports.yahoo.com/mlb/blog/big_league_stew/post/Everything-you-always-wanted-to-know-about-OPS-?urn=mlb,204667)

[Baseball Basics: OPS – Baseball Prospectus](http://www.baseballprospectus.com/article.php?articleid=2640)
